...
# means of different imp are diff
# T test
# logs[error_rates] = logs[errors]/request
# imp_a = logs[logs['impl'] == 'A'][error_rates]
# imp_b = logs[logs['impl'] == 'B'][error_rates]
# ttest(imp_a,imp_b)/pvalue

# number of daily crashes is different 
# Man whitney
