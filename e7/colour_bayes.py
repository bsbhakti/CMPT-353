...
def main(infile):
    ...
    X = data[["R","G","B"]].values/255 # array with shape (n, 3). Divide by 255 so components are all 0-1.
    ...
    print("RGB model accuracy score: ",model_rgb.score(X_test,y_test))
    ...
    print("LAB model accuracy score: ",model_lab.score(X_test,y_test))
